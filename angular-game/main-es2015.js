...
let GridBaseComponent = class GridBaseComponent {
    ...
    isValidMove(currentTileIndex, emptyTileIndex) {
...
let GridTileComponent = class GridTileComponent {
    constructor() {
...
let FifthteenPuzzleModule = class FifthteenPuzzleModule {
};
...
const GRID_SORTED = '[fifthteenPuzzle] GRID_SORTED';
class GridSorted {
    constructor(payload) {
...
/* harmony import */ var _actions_gridBase_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/gridBase.actions */ "./src/fifthteenPuzzle/store/actions/gridBase.actions.ts");
...
function reducer(state = initialState, action) {
    switch (action.type) {
        case _actions_gridBase_actions__WEBPACK_IMPORTED_MODULE_0__["GRID_SORTED"]:
            return Object.assign({}, state, { gridSorted: action.payload.gridSorted });
    }
    return state;
}
...
let RandomizerBaseComponent = class RandomizerBaseComponent {
    constructor(store) {
        this.store = store;
        this.default = {
...
RandomizerBaseComponent.ctorParameters = () => [
    { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"] }
];
...
let RandomizerContainerComponent = class RandomizerContainerComponent {
    constructor() {
        this.registerSelectedTile = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.width = "";
        this.height = "";
...
let RandomizerOptionComponent = class RandomizerOptionComponent {
    constructor() {
        this.registerSelectedTile = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.width = "";
        this.height = "";
...
let RandomizerModule = class RandomizerModule {
};
...
const SELECTION_PERFORMED = '[randomizer] SELECTION_PERFORMED';
class SelectionPerformed {
    constructor(payload) {
        this.payload = payload;
        this.type = SELECTION_PERFORMED;
    }
}
SelectionPerformed.ctorParameters = () => [
    { type: undefined }
];
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initialState", function() { return initialState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reducer", function() { return reducer; });
/* harmony import */ var _actions_randomizer_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/randomizer.actions */ "./src/randomizer/store/actions/randomizer.actions.ts");
...
function reducer(state = initialState, action) {
    switch (action.type) {
        case _actions_randomizer_actions__WEBPACK_IMPORTED_MODULE_0__["SELECTION_PERFORMED"]:
            return Object.assign({}, state, { randomSelection: action.payload });
        default:
            return state;
    }
}
...
const selectRandomizerState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])('randomizerState');
const getRandomizerState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(selectRandomizerState, (state) => state.randomizerState);
const selectRandomizerSelection = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getRandomizerState, (selection) => selection.randomSelection);
